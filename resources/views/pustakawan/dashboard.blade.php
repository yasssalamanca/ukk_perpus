...
<div class="card mt-3" style="max-width: 100%;">
    <div class="card-body">
        ...
        <div class="d-flex gap-2 mt-3">
            ...
            <a href="#" class="btn bg-success" style="width: auto;">+ Daftarkan Anggota Baru</a>
            <a href="#" class="btn bg-primary" style="background-color: #6366f1; width: auto;">+ Buat Transaksi Pinjam</a>
        </div>
    </div>
</div>
@endsection
