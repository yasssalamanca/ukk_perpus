...
@section('content')
    <div class="mb-3">
        ...
        <p>Selamat datang kembali, <strong>{{ Auth::user()->name }}</strong>. Berikut adalah ringkasan perpustakaan hari ini.
        </p>
    </div>
    ...
    <div class="card mt-3" style="max-width: 100%;">
        <div class="card-body">
            ...
            <div class="d-flex gap-2 mt-3">
                <a href="{{ route('pustakawan.buku.create') }}" class="btn bg-primary" style="width: auto;">+ Tambah Buku Baru</a>
                <a href="{{ route('pustakawan.anggota.create') }}" class="btn bg-success" style="width: auto;">+ Daftarkan Anggota Baru</a>
                <a href="{{ route('pustakawan.transaksi.create') }}" class="btn bg-primary" style="background-color: #6366f1; width: auto;">+ Buat Transaksi Pinjam</a>
            </div>
        </div>
    </div>
@endsection
