        ...
        <div class="card-body">
            <form action="{{ route('pustakawan.buku.update', $buku->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="stok" class="form-control" required min="0" value="{{ old('stok', $buku->stok) }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    @if ($buku->cover_buku)
                        <div style="margin-bottom: 10px;">
                            <img src="{{ asset('storage/cover_buku/' . $buku->cover_buku) }}" alt="Cover Lama" width="100" style="border-radius: 5px;">
                        </div>
                    @endif
