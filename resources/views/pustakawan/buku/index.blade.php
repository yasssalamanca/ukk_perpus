            ...
            <tbody>
                @forelse($bukus as $index => $buku)
                    <tr>
                        ...
                        <td>
                            @if ($buku->cover_buku)
                                <img src="{{ asset('storage/cover_buku/' . $buku->cover_buku) }}" alt="Cover" width="50" style="border-radius: 4px; object-fit: cover;">
                            @else
                        ...
                        <td>
                            @if ($buku->stok > 0)
                                <span style="background-color: #198754; color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.85rem;">{{ $buku->stok }}</span>
                            @else
                                <span style="background-color: #dc3545; color: white; padding: 2px 8px; border-radius: 12px; font-size: 0.85rem;">Habis</span>
                            @endif
                        </td>
